...
class Configuration:
    """
    Centralized configuration for Kinber backend.
    
    Loads environment variables and provides type checking and validation.
    """
    ...
    PAYPAL_API_BASE: str = "https://api.paypal.com"
    ...
    def __init__(self):
        ...
        self._load_from_env()
                ...
                # Ensure we always have a default LLM model
