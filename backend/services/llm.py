...
async def make_llm_api_call(
    ...
    model: str = getattr(config, "DEFAULT_MODEL", "gpt-3.5-turbo"),
    max_tokens: Optional[int] = None,
    temperature: Optional[float] = None,
    **kwargs
):
    """
    Execute a ChatCompletion request against OpenAI.

    :param messages: A list of {"role": ..., "content": ...} dicts.
    :param model: Model ID (default from config.DEFAULT_MODEL).
    :param max_tokens: (optional) max tokens to generate.
    :param temperature: (optional) sampling temperature.
    :param kwargs: Additional ChatCompletion parameters.
